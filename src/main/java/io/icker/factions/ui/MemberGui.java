...
public class MemberGui extends PagedGui {
    ...
    public MemberGui(ServerPlayerEntity player, Faction faction, @Nullable
    ...
    protected DisplayElement getElement(int id) {
        if (this.size > id) {
            ...
            GameProfile unknownPlayer = new GameProfile(
                UUID.randomUUID(),
            ...
            if (!profile.getId().equals(player.getUuid()) && Command.Requires.isLeader().test(
                    ...
                    if (clickType == ClickType.DROP) {
                        ...
                        gui.setSlot(
                            ...
                            new GuiElementBuilder(Items.SLIME_BALL)
                                ...
                                .setCallback(((index2, clickType2, actionType2) -> {
                                    GuiInteract.playClickSound(player);
                                    try {
                                        KickCommand.execKick(player, targetPlayer);
                                    } catch (Exception e) {
                        ...
                        gui.setSlot(
                            ...
                            new GuiElementBuilder(Items.STRUCTURE_VOID)
                                .setName(
                                    Text.translatable("factions.gui.members.entry.manage.kick.confirm.no")
