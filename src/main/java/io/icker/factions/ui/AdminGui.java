...
public class AdminGui extends SimpleGui {
            ...
            new GuiElementBuilder(Items.PLAYER_HEAD)
                ...
                .setName(
                    Text.translatable("factions.gui.admin.options.bypass")
                        .append(
                            user.bypass
                                ? Text.translatable("options.on").formatted(
                                    Formatting.GREEN
                                )
                                : Text.translatable("options.off").formatted(
                                    Formatting.RED
                                )
                        )
                )
                ...
                .setCallback((index, clickType, actionType) -> {
                    ...
                    item.set(
                        ...
                        new ProfileComponent(Optional.empty(), Optional.empty(), map)
                    );
        ...
        this.setSlot(
            ...
            new GuiElementBuilder(Items.PLAYER_HEAD)
                ...
                .setCallback((index, clickType, actionType) -> {
                    ...
                    new Message(Text.translatable("factions.gui.admin.options.audit.success")).send(
                        player,
                        false
                    );
                })
                    ...
                    .setLore(
                        List.of(
                            Text.translatable(
                                ...
                                .setStyle(
                                    Style.EMPTY.withItalic(false).withColor(
                                        Formatting.GRAY
                                    )
                                )
                        )
    ...
    private void execPower() {
        new SelectFactionGui(player, null, (faction) -> {
            ...
            inputPowGui.confirmBtn.setCallback(
                (index, clickType, actionType) -> {
                    ...
                    AdminCommand.execPower(player, faction, selectedPow[0]);
