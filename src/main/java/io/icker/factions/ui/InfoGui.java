...
public class InfoGui extends SimpleGui {
    ...
    public InfoGui(ServerPlayerEntity player, Faction faction, @Nullable
    Runnable closeCallback) {
        ...
        List<Text> membersLore = new java.util.ArrayList<>(
            members.stream()
                .map(
                    u -> Text.literal(
            ...
            new GuiElementBuilder(Items.PLAYER_HEAD)
                ...
                .setName(
                    Text.translatable(
                        ...
                        Text.literal(members.size() + (isMaxSize ? ("/" + maxSize) : ""))
